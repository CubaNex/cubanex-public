  ...
  return (
    <div className="main relative bg-[#010813]">
      ...
      <ScrollReveal delay={0.1}>
        <div className="flex px-4 pt-[140px] pb-[80px] sm:pb-[80px] sm:pt-[170px] flex-col gap-2 items-center justify-center abhBg">
          <h1
      ...
      <section className="pt-28">
        ...
        <div className="relative pb-24 z-10 px-6 grid max-w-[1300px] mx-auto text-white gap-10 md:grid-cols-4">
          {[
            {
              color: "cyan",
              icon: (
              ...
              title: "Herencia Cubana",
              text: "Basado en la rica cultura, resiliencia y espíritu innovador de Cuba.",
            },
            {
              color: "yellow",
              icon: (
              ...
              text: "Construido con transparencia, unidad y prosperidad compartida.",
            },
            {
              color: "emerald",
              icon: (
              ...
              title: "Visión Global",
              text: "Conectando a Cuba con el mundo a través de la innovación descentralizada.",
            },
            {
              color: "blue",
              icon: (
              ...
              text: "Pioneros en blockchain ecológica para una economía verde.",
            },
          ].map((item, i) => (
            <ScrollReveal key={i} delay={0.1 * i}>
              <div className="p-8 border border-[#00D2FF]/17 h-full rounded-2xl bg-gradient-to-br from-gray-900 to-black hover:scale-[1.02] hover:-translate-y-2 hover:shadow-[0_8px_30px_rgba(0,210,255,0.1)] transition-all duration-700">
