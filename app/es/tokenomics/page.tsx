  ...
  return (
    <div className="main w-full relative  bg-[#010813]">
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-[#00D2FF]/10 border-b border-white/10">
                      <th className={`${orbitron.className} px-6 py-5 text-[#00D2FF] font-bold text-sm tracking-wider uppercase`}>Asignación</th>
                      <th className={`${orbitron.className} px-6 py-5 text-[#00D2FF] font-bold text-sm tracking-wider uppercase`}>Porcentaje</th>
                      <th className={`${orbitron.className} px-6 py-5 text-[#00D2FF] font-bold text-sm tracking-wider uppercase`}>Cantidad de Tokens</th>
                    </tr>
                  </thead>
      ...
      <UtilityCarousel 
        titleText={
           <>
             Utilidad en el <span className="text-[#00D2FF]">Mundo Real</span>
           </>
        }
        items={[
          {
